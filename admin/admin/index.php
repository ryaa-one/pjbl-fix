...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_admin_id'])) {
    ...
    if ($deleteAdminId === (int) $_SESSION['user_id']) {
        ...
        $stmtDeleteAdmin = mysqli_prepare($koneksi, "DELETE FROM users WHERE id = ? AND level = 'user'");
    ...
    <div class="admin-layout">
      ...
      <main class="admin-content">
        <div class="admin-page-header events-header">
          <h1 class="admin-page-title">User / Event Creator</h1>
        ...
        <form class="admin-toolbar" method="get" action="">
          <div class="admin-search">
            ...
            <input class="admin-search__input" type="search" name="search" placeholder="Search user" value="<?= htmlspecialchars($search) ?>" />
          </div>
