...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $execCreateEvent = mysqli_query($koneksi, $queryCreateEvent);
            ...
            <div>
              ...
              <select class="admin-field" id="category_id" name="category_id">
                ...
                <?php foreach ($categories as $category): ?>
                  <option value="<?= htmlspecialchars($category['id']) ?>" <?= (string) $formData['category_id'] === (string) $category['id'] ? 'selected' : '' ?>>
            ...
            <div>
              ...
              <select class="admin-field" id="city_id" name="city_id">
                ...
                <?php foreach ($cities as $city): ?>
                  <option value="<?= htmlspecialchars($city['id']) ?>" <?= (string) $formData['city_id'] === (string) $city['id'] ? 'selected' : '' ?>>
            ...
            <div class="admin-upload">
              <div class="admin-upload__preview">
                ...
                <div class="admin-upload__meta">
                  ...
                  <div class="admin-upload__text">Gunakan gambar yang tajam agar event terlihat lebih profesional di daftar admin maupun halaman publik.</div>
                </div>
              </div>
              <div class="admin-upload__controls">
                ...
                <div class="admin-upload__file" id="thumbnail-file-label">
                  <?= $formData['thumnail'] !== '' ? htmlspecialchars($formData['thumnail']) : 'Format yang didukung: JPG, PNG, GIF, WEBP. Maksimal gambar yang ringan dan jelas.' ?>
                </div>
