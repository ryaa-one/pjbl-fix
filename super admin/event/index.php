...
include '../../process/getSuperAdminEvent.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_event_id'])) {
    ...
    $stmtDeleteEvent = mysqli_prepare($koneksi, "DELETE FROM events WHERE events.id = ?");
    if ($stmtDeleteEvent) {
      ...
      <main class="admin-content">
        ...
        <form class="admin-toolbar" method="get" action="">
          ...
          <select class="admin-field admin-toolbar__select" name="sort">
            ...
            <option value="admin" <?= $sort === 'admin' ? 'selected' : '' ?>>Urutkan: Admin</option>
          </select>
          ...
          <table class="events-table">
            ...
            <thead>
              <tr>
                ...
                <th class="col-category">Admin</th>
