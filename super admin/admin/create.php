...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($execExistingAdmin && mysqli_num_rows($execExistingAdmin) > 0) {
            ...
            $queryCreateAdmin = "INSERT INTO users (name, email, password, whatsapp, instagram, profile_photo, level) VALUES ('$nameEscaped', '$emailEscaped', '$passwordEscaped', '', '', '', '$levelEscaped')";
